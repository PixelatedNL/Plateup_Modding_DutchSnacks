Shader "Unlit/TripleVerticalGradient"
{
    Properties
    {
        _TopColour("Top Gradient Colour: ", Color) = (0.32,0.34,0.21,1)
        _MiddleColour("Middle Gradient Colour: ", Color) = (0.27,0.16,0.48,1)
        _BottomColour("Bottom Gradient Colour: ", Color) = (0.32,0.10,0.75)
