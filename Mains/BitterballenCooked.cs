...
{
    public class BitterballenCooked : CustomItem
    {
        ...
        public override void OnRegister(GameDataObject gameDataObject)
        {
            ...
            if (!Prefab.HasComponent<BitterballenCookedItemView>())
            {
                var view = Prefab.AddComponent<BitterballenCookedItemView>();
                view.Setup(Prefab);
            }
        }
    }

    public class BitterballenCookedItemView : ObjectsSplittableView
    {
